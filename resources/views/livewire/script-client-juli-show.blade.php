...
<script src="{{url('backend/dashboard/assets/plugins/DataTables/datatables.min.js')}}"></script>
<script src="{{url('backend/dashboard/assets/js/connect.min.js')}}"></script>
<script src="{{url('backend/dashboard/assets/js/pages/datatables.js')}}"></script>